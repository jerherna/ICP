...
(function($) {
    ...
    $.sessionTimeout = function(options) {
        ...
        if (typeof opt.onWarn !== 'function') {
            ...
            $('body').append('<div class="modal fade" id="session-timeout-dialog" tabindex="-1" role="dialog" aria-labelledby="modal-session-timeout" aria-hidden="true"> \
              <div class="modal-dialog modal-md""> \
                <div class="modal-content"> \
                  <div class="modal-header"> \
                    <h5 class="modal-title" id="modal-session-timeout">' + opt.title + '</h5> \
                  ...
                  <div class="modal-footer"> \
                    <button id="session-timeout-dialog-logout" type="button" class="btn btn-sm btn-warning">' + opt.logoutButton + '</button> \
