...
<form action="/account" method="POST" enctype="multipart/form-data">
	...
	<!--<div class="col-sm-4 ml-auto">
		<div class="d-flex justify-content-center">
			<div class="show-image">
				<img src="/hris-modern/hris-personneldata.nsf/img/empty-profile.jpg?" data-img-name="" class="profile-pic img-fluid img-thumbnail rounded">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control file-upload-data form-control-sm" disabled="" placeholder="Upload Image" hidden="">
				</div>
			</div>
		</div>
	</div>-->
	...
	<div class = "row">
		<div class="col-sm-3 float-right pb-5">
			<span>Request Status: {{$data->request_status}}</span><br>
			<span>Requestor: {{$data->requestor}}</span>
		</div>
		<div class="col-sm-12">
			<div class="card mb-3">
							...
							<div class="d-flex justify-content-center">
								<div class="show-image">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control file-upload-data" disabled="" placeholder="Upload Image" hidden readonly>
									</div>
								</div>
							</div>
						</div>
