...
<div class="page-header">
	...
	@can('admin_only')
		<a href="/editmember/{{$data->id}}" class="btn btn-primary float-right">Edit</a>
	@endcan
	@can('user_only')
		<a href="/requestmember/{{$data->id}}" class="btn btn-primary float-right">Change Request</a>
	@endcan
					...
					<div class="form-row">
						<div class="col-sm-6 no-gutters">
							...
							<div class="form-group row">
								...
								<div class="col-sm-8">
									<input name="Latitude" value="{{$data->latitude}}" data-cus-label="Latitude" data-value="" class="form-control form-control-sm" readonly>
								</div>
							</div>
							<div class="form-group row">
								<label class="col-sm-4 col-form-label">Longitude</label>
								<div class="col-sm-8">
									<input name="Longitude" value="{{$data->longitude}}" data-cus-label="Longitude" data-value="" class="form-control form-control-sm" readonly>
								</div>
							</div>
