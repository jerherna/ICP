...
return [
    ...
    'updated'            => [
        ...
        'modified' => [
            ...
            'request_status' => 'This admin has set the status of this request from <strong>:old</strong> to <strong>:new</strong>',
            'change_request_by' => 'This change was requested by <strong>:new</strong>'
        ],
    ],
